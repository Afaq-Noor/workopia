 ...
 <div
            ...
            >
                ...
                @method('PUT')
                    ...
                    placeholder="Software Engineer" :value="old('title', $job->title)" />
                  ...
                  <x-inputs.text-area id="description" name="description" label="description"
                   ...
                   />
                    ...
                    <x-inputs.text id="salary" name="salary" label="Salary" type="number"
                    placeholder="80000"  :value="old('salary', $job->salary)" />
                   ...
                   placeholder="Health insurance, 401k, paid time off"  :value="old('benefits', $job->benefits)" />
                    ...
                    <x-inputs.select id="job_type"  name="job_type" label="Job Type"
                     :value="old('job_type', $job->job_type)" :options="['Full-Time' => 'Full-Time' , 'Part-Time' => 'Part-Time' ,
                     'Contract' => 'Contract' ,'Temporary' => 'Temporary' ,'Internship' => 'Internship' ,
                     'Volunteer' => 'Volunteer' ,'On-Call' => 'On-Call' ]" />
                    ...
                    <x-inputs.text id="state" name="state" label="Job Title" 
                   ...
                   placeholder="Company Description" :value="old('company_description', $job->description)" />
                    ...
                    <x-inputs.file id="company_logo" name="company_logo" label="company_logo"  :value="old('company_logo', $job->company_logo)" />
